...
/**
 * blancoValueObjectTsが利用するメッセージ。
 */
public class BlancoValueObjectTsMessage {
    /**
     * メッセージをプロパティファイル対応させるための内部的に利用するリソースバンドルクラス。
     */
    protected final BlancoValueObjectTsMessageResourceBundle fBundle = new BlancoValueObjectTsMessageResourceBundle();

    /**
     * メッセージ定義ID[BlancoValueObjectTs]、キー[MBVOJI01]の文字列を取得します。
     *
     * No.2:
    ...
    /**
     * メッセージ定義ID[BlancoValueObjectTs]、キー[MBVOJI02]の文字列を取得します。
     *
     * No.3:
    ...
    /**
     * メッセージ定義ID[BlancoValueObjectTs]、キー[MBVOJI03]の文字列を取得します。
     *
     * No.4:
    ...
    /**
     * メッセージ定義ID[BlancoValueObjectTs]、キー[MBVOJI04]の文字列を取得します。
     *
     * No.5:
    ...
    /**
     * メッセージ定義ID[BlancoValueObjectTs]、キー[MBVOJI05]の文字列を取得します。
     *
     * No.6:
    ...
    /**
     * メッセージ定義ID[BlancoValueObjectTs]、キー[MBVOJI06]の文字列を取得します。
     *
     * No.7:
    ...
    /**
     * メッセージ定義ID[BlancoValueObjectTs]、キー[MBVOJI07]の文字列を取得します。
     *
     * No.8:
    ...
    /**
     * メッセージ定義ID[BlancoValueObjectTs]、キー[MBVOJI08]の文字列を取得します。
     *
     * No.9:
    ...
    /**
     * メッセージ定義ID[BlancoValueObjectTs]、キー[MBVOJA01]の文字列を取得します。
     *
     * No.10:
